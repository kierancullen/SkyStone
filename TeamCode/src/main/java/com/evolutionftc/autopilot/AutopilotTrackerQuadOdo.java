...
public class AutopilotTrackerQuadOdo extends AutopilotTracker {
    ...
    //
    public AutopilotTrackerQuadOdo(DcMotor xF, DcMotor xB, DcMotor yL, DcMotor yR, double xRadius, double yRadius, double xOffset, double yOffset, double ticksPerUnit) {
        this.xF = xF;
        this.xB = xB;
        this.yL = yL;
        this.yR = yR;
    ...
    public AutopilotTrackerQuadOdo(DcMotor xF, DcMotor xB, DcMotor yL, DcMotor yR, double xRadius, double yRadius, double ticksPerUnit) {
        this.xF = xF;
        this.xB = xB;
        this.yL = yL;
        this.yR = yR;

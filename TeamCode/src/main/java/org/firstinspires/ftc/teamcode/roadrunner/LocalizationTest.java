...
public class LocalizationTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()) {
            ...
            telemetry.addData("leftEncoder", bl.getCurrentPosition());
            telemetry.addData("rightEncoder", br.getCurrentPosition());
            telemetry.addData("centerEncoder", tl.getCurrentPosition());
            telemetry.update();
        }
    }
}
